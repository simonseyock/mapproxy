...
from mapproxy.config.configuration.global_conf import preferred_srs
...
class CacheConfiguration(ConfigurationBase):
    ...
    def source(self, params=None, tile_grid=None, tiled_only=False):
        ...
        from extent import map_extent_from_grid
    ...
    def caches(self):
        ...
        from extent import merge_layer_extents
        from extent import map_extent_from_grid
